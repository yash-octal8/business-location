                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            <form action=" {{ route('location.store') }} " method="post" class="w-[50%] mx-auto">
                                <h1 class="text-center text-2xl text-pink-400 font-bold">Create Location</h1>
                                @csrf
                                <div class="flex flex-col gap-3 ">
                                    <label for="" class="text-slate-700 text-xl">name</label>
                                    <input type="text" name="name" class="rounded-md border-sky-200 border-2">
                                </div>
                                ...
                                <div class="flex flex-col gap-3 my-3">
                                    ...
                                    <select name="business_id" id="" class="rounded-md border-sky-200 border-2">
