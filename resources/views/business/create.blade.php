                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            <form action=" {{ route('business.store') }} " method="post" class="w-[50%] mx-auto">
                                <h1 class="text-center text-2xl text-pink-400 font-bold">Create Business</h1>
                                @csrf
                                <div class="flex flex-col gap-3 ">
                                    <label for="" class="text-slate-700 text-xl">name</label>
                                    <input type="text" name="name" class="rounded-md border-sky-200 border-2" value=" {{ old('name')}} ">
                                </div>
                                ...
                                <div class="flex flex-col gap-3 ">
                                    ...
                                    <input type="text" name="address" class="rounded-md border-sky-200 border-2" value=" {{ old('address')}} ">
                                </div>
                                ...
                                <div class="flex flex-col gap-3 ">
                                    ...
                                    <input type="text" name="email" class="rounded-md border-sky-200 border-2" value=" {{ old('email')}} ">
                                </div>
                                <span class="text-red-500 font-semibold">@error('email') {{ $message }} @enderror</span>
                                <div>
                                    <button type="submit" class="mt-5 bg-[#0ea5e9] text-white py-2 px-4 font-bold rounded-md">create</button>
                                </div>
                            </form>
                        </div>
                    </div>
